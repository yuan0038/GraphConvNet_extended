...
from models.GraphConvNet import *
try:
...
parser.add_argument('-j', '--workers', type=int, default=32, metavar='N',
...
parser.add_argument("--get_diversity", action='store_true', default=False,
                    help='whether to calculate  the features diversity of  model')
parser.add_argument("--visualize_fm", action='store_true', default=False,
                    help='whether to calculate  the features diversity of  model')
...
def main():
    ...
    if args.local_rank == 0:
        _logger.info('Model %s created, param count: %d  trainable params: %d' %
